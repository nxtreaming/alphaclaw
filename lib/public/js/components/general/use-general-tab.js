...
export const useGeneralTab = ({
  ...
  const [devicePollingStarted, setDevicePollingStarted] = useState(false);
  ...
  const devicePoll = usePolling(
    ...
    2000,
    { enabled: gatewayStatus === "running" && devicePollingStarted },
  );
